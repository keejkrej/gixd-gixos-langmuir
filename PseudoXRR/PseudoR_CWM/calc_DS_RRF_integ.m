function [DS_RRF, DS_term,  RRF_term] = calc_DS_RRF_integ(beta_space, qxy0, energy, alpha, Rqxy_HWHM, DSqxy_HWHM, DSbeta_HWHM, tension, temp, amin)
...
for idx = 1:length(beta_space)
    fun = @(tt,tth) integral_delta_beta_delta_phi(tt, tth, kbT_gamma, wave_number, alpha, Qmax);
