    ...
    def load_scan(self, filename = None, auto_load_images = True, auto_remove_double = False):
        ...
        for col_name in column_names:    
            if not col_name.find('lambda') == -1:
                ...
                self.is_eiger = True
            elif not (col_name.find('mythint') == -1 and col_name.find('mythmax') == -1 and col_name.find('mythroi1') == -1 and col_name.find('mythroi2') == -1):
                self.is_mythen = True
        ...
        if not pilatus_idx is None:
            ...
            for idx in pilatus_idx:
                ...
                if (filename+".tif") in file_list:
                    ...
                    #print(fabio.open(filename+".tif").data)
                    cnt += 1
